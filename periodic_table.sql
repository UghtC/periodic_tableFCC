...
--
-- Name: properties atomic_number_ref; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomic_number_ref FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
